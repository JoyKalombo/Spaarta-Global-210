...
class City(Country):
    def __init__(self, city_name, continent, climate, language):
        ...
        Country.__init__(self, continent, climate, language)
        # super().__init__()
    # -------------------------------------------------------------------------------------- #
...
for i in range(len(list_of_numbers)):
    if Number(list_of_numbers[i]).is_prime():
        list_of_primes.append(list_of_numbers[i])
...
multuples_of_3AND4 = []
for i in range(len(list_of_numbers)):
    if Number(list_of_numbers[i]).divisible_by_n(3*4):
        multuples_of_3AND4.append(list_of_numbers[i])

print(multuples_of_3AND4)
# -------------------------------------------------------------------------------------- #
